...
public class DecorateController {
    ...
    public void decorateStart(Principal principal, DecorateStartRequestDTO req) {
        Long memberId = Long.parseLong(principal.getName());
        DecoreStartResponseDTO res = decorateService.startDeocorate(memberId,req.roomId());
        messagingTemplate.convertAndSend("/topic/room/" + req.roomId(), WsResponse.success("DECOR_START",res));
    }
